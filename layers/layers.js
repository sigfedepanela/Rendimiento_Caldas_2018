...
jsonSource_RendimientodePanelaTonHa_2.addFeatures(features_RendimientodePanelaTonHa_2);var lyr_RendimientodePanelaTonHa_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/RendimientodePanelaTonHa_2_0.png" />  3,78 - 3,98 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_1.png" />  3,98 - 4,48 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_2.png" />  4,48 - 4,97 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_3.png" />  4,97 - 5,97 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_4.png" />  5,97 - 6,96 <br />'
        });
...
lyr_Limite_Departamental_1.set('fieldAliases', {'DEPARTAMEN': 'DEPARTAMEN', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', 'AÑO': 'AÑO', });
...
lyr_Limite_Departamental_1.set('fieldImages', {'DEPARTAMEN': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', 'AÑO': 'Range', });
...
lyr_Limite_Departamental_1.set('fieldLabels', {'DEPARTAMEN': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', 'AÑO': 'inline label', });
